...
<head>
<meta charset="UTF-8">
<title>Mise a jours des information d'un rapport</title>
 ...
 <div class="row">
    ...
    <div class="row">
        <div class="input-field col s6">
          <input id="last_name" type="text" class="validate" name="matricule" value="<%= matricule %>">
     ...
     <div class="row">
      ...
      <div class="row">
        <div class="input-field col s6">
          <input id="last_name" type="text" class="validate" name="id" value="<%= id %>">
      ...
      <div class="row">
        <div class="input-field col s12">
           <input type="text" class="datepicker" id ="dateemprunt" name="dateemprunt" value="<%= dateemprunt %>">
          <label for="dateemprunt">Date Emprunt</label>
        </div>
      </div>
       <div class="row">
        <div class="input-field col s12">
           <input type="text" class="" id="daterestitution" name="daterestitution" value="<%= daterestitution %>">
