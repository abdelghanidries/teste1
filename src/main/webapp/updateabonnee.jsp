...
<head>
<meta charset="UTF-8">
<title>Mise a jour Abonnee</title>
...
<script>function Menu(e){
 ...
 <%-- Récupération des paramètres d'URL --%>
    ...
    %>
<form class="needs-validation pt-5" method="post" action="UpdateAbonnee" novalidate>
  <div>
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom01"  name="nom" value="<%= nom %>">
      <div>
    ...
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom02" name="prenom"   value="<%= prenom %>">
       <div>
    ...
    <% } %>
      ...
      <input type="text" class="form-control" id="validationCustom02" name="matricule" value="<%= matricule %>" >
       <div>
  ...
  <div class="col-md-6 mb-3">
   ...
   <div class="col-md-6 mb-3">
    <label for="mdp" >Password</label>
      ...
      <input type="password" class="form-control" id="inputPassword3" name="mdp" value="<%= motpass %>">
      <div>
    ...
    <option value="enseignant"><%= role%></option>
